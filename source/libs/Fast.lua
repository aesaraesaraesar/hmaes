...
chsource = Redis:get(Fast..'chsource') or "creative179"
devsource = Redis:get(Fast..'devsource') or "IP_CQ"
...
return send(msg_chat_id,msg_id,'\n⌯ مرحبا بك في السجل المدني الخاص بسورس هيلاس د\nاكتب اسمك الا:',"md",true)  
end
